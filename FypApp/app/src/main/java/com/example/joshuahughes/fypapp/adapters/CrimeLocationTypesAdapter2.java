 ...
 */
public class CrimeLocationTypesAdapter2 extends ArrayAdapter<CrimeLocationTypeModel> {

    private final Context context;
    private ArrayList<CrimeLocationTypeModel> clTypesArray;

    public CrimeLocationTypesAdapter2(Context c, ArrayList<CrimeLocationTypeModel> array){
        super(c, -1, array);
        this.context = c;
    ...
    public View getView(int position, View convertView, ViewGroup parent){
        ...
        View rowView = inflator.inflate(R.layout.cl_type_row, parent, false);
